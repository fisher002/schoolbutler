    ...
    <div v-if="params.type == 'detail'">
      ...
      >
        ...
        <el-form-item label="性别">
          ...
          <div v-else class="select-width">
            <el-radio v-model="data.sex" label="M">男生</el-radio>
            <el-radio v-model="data.sex" label="F">女生</el-radio>
          </div>
        </el-form-item>
        <el-form-item label="工号">
          <span v-if="isShowEdit == false">{{ data.teacherId }}</span>
          <el-input
            v-else
            v-model="data.teacherId"
            class="input-width"
        ...
        <el-form-item label="邮箱">
          ...
          <el-input v-else v-model="data.email" class="input-width" clearable>
          </el-input>
        </el-form-item>
        <el-form-item label="手机号码" prop="phone">
...
<script>
import api from "./teachermanageUrl";
