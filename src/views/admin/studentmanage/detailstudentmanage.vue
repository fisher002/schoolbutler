  ...
  <div class="form-box">
    <div v-if="params.type == 'add'">
      ...
      >
        <div class="comm_select">
          ...
          <div class="demo_width"></div>
          <el-form-item label="请选择年级" prop="grade" v-if="commData.classId">
            <el-select
            ...
            <div>
              ...
              <el-form-item label="性别">
                <div class="select-width">
                  <el-radio v-model="item.sex" label="M">男生</el-radio>
                  <el-radio v-model="item.sex" label="F">女生</el-radio>
                </div>
              </el-form-item>
    ...
    <div v-if="params.type == 'detail'">
      ...
      >
        ...
        <el-form-item label="性别">
          <span v-if="isShowEdit == false">{{ formatSex(data.sex) }}</span>
          <div class="select-width" v-else>
            <el-radio v-model="data.sex" label="M">男生</el-radio>
            <el-radio v-model="data.sex" label="F">女生</el-radio>
          </div>
        </el-form-item>
        ...
        <el-form-item label="生日">
          <span v-if="isShowEdit == false">{{ data.birth }}</span>
          <el-input
            v-else
            v-model="data.birth"
            class="input-widths"
        ...
        <el-form-item label="手机号码">
          <span v-if="isShowEdit == false">{{ data.phone }}</span>
          <el-input
            v-else
            v-model="data.phone"
            class="input-widths"
...
export default {
  ...
  methods: {
    ...
    // 选择年级后
    handleGrade() {
      this.data[0].studentId = this.returnSchoolId(this.commData);
    ...
    addDataItem() {
      ...
      // 学号生成 校区 二级院校 专业 班级信息一起绑定
      item.studentId = this.returnSchoolId(this.commData);
      this.data.push(item);
    },
    // 去除data条数
    minuDataItem(res) {
    ...
    // 学号生成 年份+校区id+二级学院id+年级+班级id+（1~正无穷）
    returnSchoolId(res) {
      return `${new Date().getFullYear()}${res.schoolId}${res.collegeId}${
        res.grade
      }${res.classId}${this.number++}`;
    },
    ...util,
  },
};
